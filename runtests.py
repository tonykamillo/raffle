...
import click, unittest, importlib
...
@click.option('--module', '-m', default=None, help='Module to your test cases. It\'s needed to be a import path style. Ex: python runtests.py -m test.test_module')
@click.option('--case', '-c', multiple=True, default=[], help='Especify the test cases you want to test. Ex: python runtests.py -c some.path.TestCase -c another.path.TestCase')
